...
export default Vue.extend({
  ...
  methods: {
    setColors() {
      // @ts-ignore
      const cathegoriesNumber = this.dataPoints.datasets.length;
      for (let i = 0; i < cathegoriesNumber; i++) {
        // @ts-ignore
        this.dataPoints.datasets[i].backgroundColor = pointColors[i];
        // @ts-ignore
        this.dataPoints.datasets[i].borderColor = borderColors[i];
      }
    },
